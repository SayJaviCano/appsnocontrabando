...
if( isset($_GET['qr']) )
{
	...
	$qr = LimpiaParametros((isset($_GET['qr']) ? $_GET['qr'] :""));
	...
	if (is_numeric($qr)) { 
			...
			switch ($qr) {
				...
				case 6:
					...
					break;
				case 7:
					$estanco = "CASTILLEJA DE LA CUESTA-002";
					$procedencia = "Pulsera";
					break;
				case 8:
					$estanco = "SEVILLA-004";
				...
				case 12:
					...
					break;
				case 13:
					$estanco = "LLAS CABEZAS DE SAN JUAN 004";
					$procedencia = "Pulsera";
					break;
				case 14:
					$estanco = "SEVILLA 13";
					...
					break;
				case 15:
					$estanco = "ALMENDRALEJO-003";
					$procedencia = "Pulsera";
					break;
				case 16:
					$estanco = "CHICLANA 003";
					$procedencia = "Pulsera";
					break;
				case 17:
					$estanco = "MALAGA 78";
		...
		if ($qr > 0 && $estanco != "" ) { 
			...
			//$estanco = $estancos_array[$qr-1];

			/********************* cookie *********** */
			if ( isset($_COOKIE["nocontrabando_app"]) ) {

				if (!empty($_COOKIE["nocontrabando_app"]) ) {				
					$session_id = $_COOKIE["nocontrabando_app"];				
				} else {
					...
					$session_id = $session_id . "_" . $numero_aleatorio;
					setcookie("nocontrabando_app", $session_id , time()+(60*60*24*365) , "/");
				}
			} else {
			...
			echo "<br> Estanco: ";
			echo $estancos_array[$qr-1];

			echo "<br> navegador: ";
			echo $navegador . " " . $version;
			...
			*/
			...
			if ($dispositivo=="Escritorio") {
				...
				$url_app = "https://nocontrabando.altadis.com/?pop=appNoContrabando";
			...
			$sql2 = "INSERT INTO log_app (fecha, session_id, ip, qr, estanco, procedencia, navegador, version, plataforma, dispositivo, url_redirect) VALUES";
			$sql2 = $sql2 . "('$fecha', '$session_id', '$ip', '$qr', '$estanco', '$procedencia', '$navegador', '$version', '$plataforma', '$dispositivo', '$url_app')";
			$rs2 = $mysqli->query($sql2);

			//echo "<br><br>$url_app<br>";
