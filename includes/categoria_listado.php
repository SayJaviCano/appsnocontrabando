...
<?php if ($categoria_nombre_select != "") {    ?>

  <div class="bg-cabecera">
    <div class="container">
      <div class="col-md-12 content-cab">
        <h1><?php echo $categoria_nombre_select; ?></h1>
      </div>
    </div>
  </div>
...
<script>
  ...
  function carga_listado() {
    pagina = pagina + 1;
    url_ajax = dominio + 'includes/ajax_categorias_listado.php?c=<?php echo $categoria_id_select; ?>&p=' + pagina;
