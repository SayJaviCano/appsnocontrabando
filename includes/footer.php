	...
	<div class="container">
		<div class="row footer-1">
			...
			<div class="col-12 col-md-4 col-footer-1">
				<p><a href="https://www.altadis.com" alt="Imperial Brands España - Altadis"><img src="<?php echo $dominio; ?>images/imperial-brands-logo.png" alt="Imperial Brands España" class="img-fluid footer-logo"></a></p>
				<p>
